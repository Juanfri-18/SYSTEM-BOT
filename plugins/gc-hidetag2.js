...
**/
    ...
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029Vac3noUDTkJuOpfPTa39'}}}}}, {});
    }
  }
};
handler.command = /^(noti|tag|aviso|comunicar)$/i;
handler.group = true;
handler.admin = true;
